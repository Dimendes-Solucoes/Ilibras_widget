...
.ilibras-widget-agendar:hover:not(:disabled) {
  background: #F2F7FD;
  border-color: #357ABD;
}

.ilibras-widget-agendar:disabled {
  opacity: 0.6;
  cursor: not-allowed;
}

.ilibras-widget-dica-agendar {
  margin-top: -14px;
  text-align: center;
}
...
.ilibras-widget-erro::before {
  content: "\\26A0";
  font-size: 13px;
  line-height: 1.3;
}

.ilibras-widget-erro[hidden] {
  display: none;
}

.ilibras-widget-form-group input.ilibras-widget-invalido {
  border-color: #b02a37;
  border-width: 2px;
}

/* Aviso de falha de serviço / limite de uso. */
.ilibras-widget-aviso {
  background: #fdf2f2;
...
.ilibras-widget-aviso[hidden] {
  display: none;
}

.ilibras-widget-aviso:focus-visible {
  outline: 3px solid #b02a37;
  outline-offset: 2px;
}

.ilibras-widget-aviso-texto {
  margin: 0;
}

/* Plano de contingência: aparece quando a API não responde. */
.ilibras-widget-fallback {
  margin-top: 10px;
  padding-top: 10px;
...
.ilibras-widget-fallback p {
  margin: 0 0 6px;
}

.ilibras-widget-fallback ul {
  margin: 0;
  padding-left: 18px;
  list-style: disc;
}

.ilibras-widget-fallback li {
  margin: 2px 0;
}

.ilibras-widget-fallback a {
  color: #1f4f7a;
  font-weight: 600;
}

.ilibras-widget-status {
  font-size: 13px;
  color: #495057;
  margin: 0;
  min-height: 1em;
...
.ilibras-widget-fallback a:focus-visible {
